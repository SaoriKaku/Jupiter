...
public class MongoDBConnection implements DBConnection {
	...
	public void saveItem(Item item) {
		...
		// judge whether item_id has existed in mongoDB = IGNORE in MySQL
		// similar to list, type is Document, contains all Document whose item_id = target
		FindIterable<Document> iterable = db.getCollection("items").find(new Document("item_id", item.getItemId()));
		// there are no document with item_id = target
		if(iterable.first() == null) {
